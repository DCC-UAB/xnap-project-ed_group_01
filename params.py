...
yolo_model = "best_iit"
model_yolo_entrenat = f"{parent}/Detection/YOLO/models_entrenats/{yolo_model}.pt"
...
yolo_entrenat_recog_detect = f"{parent}/PIPELINE/YOLO/models_entrenats/{yolo_pipeline_model}.pt"
yolo_pipeline_store_files = f"{parent}/PIPELINE/YOLO"

# PIPELINE (PHOCNET)
saved_model_phocnet = f"{parent}/PIPELINE/PHOCNET/models_entrenats/"
