...
class Dataset(Dataset):
    ...
    def __init__(self, mat_data, img_dir, type_data = "testdata", resize = (32,128)):
        annots = loadmat(mat_data)
        ...
        for idx in range(annots[type_data][:,:].shape[1]):
            path = annots[type_data][:,idx][0][0][0]
            ...
            label = annots[type_data][:,idx][0][1][0]
            self.img.append(img)
...
mat_data = "C:/Users/adars/OneDrive/Escritorio/ProjecteNN/IIIT5K/traindata.mat"
img_dir = "C:/Users/adars/OneDrive/Escritorio/ProjecteNN/IIIT5K/"
type_data = "traindata"
aux = Dataset(mat_data, img_dir, type_data)
#aux[0]
